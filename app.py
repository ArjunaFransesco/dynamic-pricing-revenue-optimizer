...
st.set_page_config(
    page_title="Dynamic Pricing & Price Elasticity Revenue Optimizer",
    page_icon="🤖",
    layout="wide"
)

st.title("🎯 Dynamic Pricing & Price Elasticity Revenue Optimizer")
st.markdown("**Domain**: `Retail / Revenue Management` | **Tech Stack**: `Scipy Optimize, Scikit-Learn, Streamlit`")
...
with col2:
    ...
    if os.path.exists(model_path) and os.path.exists(scaler_path):
        ...
        st.info(f"Predicted `optimal_target_price`: **{pred}**")
